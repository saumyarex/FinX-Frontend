  ...
  return (
    ...
    <Navbar className="navbarCSS" collapseOnSelect expand="lg" style={{position: 'relative', zIndex: "2 !important"}}>
      {/* <Navbar className="navbarCSS" collapseOnSelect expand="lg" bg="dark" variant="dark"> */}
        <Navbar.Brand href="/" className="text-white navTitle">Financial Management System</Navbar.Brand>
        <Navbar.Toggle
        ...
        <Navbar.Collapse id="responsive-navbar-nav" style={{color: "white"}}>
          {user ? (
            ...
            <Nav>
            <Link to="/blog">
        <p style={{color: "white", margin:"9px"}}>Blogs</p>
      </Link>
            <Link to="/news">
        <p style={{color: "white", margin:"9px"}}>News</p>
      </Link>
      <Link to="/profile">
        <p style={{color: "white", margin:"9px"}}>Profile</p>
      </Link>
